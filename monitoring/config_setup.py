#!/usr/bin/env python3
"""
LangSmith Configuration Setup for LangGraph Multi-Agent Platform
...
class LangSmithConfigManager:
    ...
    def setup_configuration(self, api_key: Optional[str] = None, project_name: Optional[str] = None) -> bool:
        ...
        print("=== LangGraph Multi-Agent Platform - LangSmith Setup ===")
        ...
        # Get project name
        if not project_name:
            project_name = input("Enter project name (default: langgraph-multi-agent-platform): ").strip()
            if not project_name:
    ...
    def _update_env_file(self, config: Dict[str, str]):
        ...
        with open(self.config_file, 'w') as f:
            f.write("# LangGraph Multi-Agent Platform Configuration\n")
        ...
        try:
            ...
            if not existing_project:
                ...
                project = client.create_project(
                    ...
                    description="LangGraph Multi-Agent Platform monitoring"
                )
...
#!/usr/bin/env python3
"""
LangGraph Multi-Agent Platform - Monitoring Setup
...
def initialize_monitoring():
    ...
    print("🚀 Initializing LangGraph Multi-Agent Platform Monitoring")
    print("=" * 60)
